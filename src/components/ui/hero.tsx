...
const Hero = React.forwardRef<HTMLElement, HeroProps>(
  (
    ...
    return (
        ...
        ref={ref}
        className={cn(
          "relative z-0 flex min-h-[100svh] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background",
          className,
        )}
        {...props}
      >
        ...
        <motion.div
          ...
          className="relative z-50 container flex justify-center flex-1 flex-col gap-4 px-5 md:px-10 translate-y-6 md:translate-y-8"
        >
